...
\pointskillNinety{}{S3}
\pointskillNinety{}{Lambdas}
\pointskillNinety{}{Secrets Manager}
\pointskillEighty{}{IAM}
\pointskillEighty{}{CloudFront}
\pointskillEighty{}{MediaConvert}
...
\addtothirdsidebar{
  ...
  \pointskillSixty{}{OpenAI API}
	...
	\aboutme{
With over 26 years of experience in developing and delivering web applications for digital TV and media platforms, as well as for laptops and mobile devices, I have overseen the architecture, development, and deployment of two major web projects involving Azure. \\\\
Collaborating closely with a team of four developers and one QA specialist, \\\\
I focus on enhancing and consolidating our software stack, creating modules, and conducting code reviews.\\\\
In my role as a tech lead, I also uphold best practices in agile methodologies, backlog management, and documentation. \\\\
Passionate about web innovation, I am committed to solving complex problems and delivering user-friendly, scalable solutions for our clients, utilizing cutting-edge technologies such as AWS, Angular, Vue.js, React, PHP, Python, and HTML5}, with a slice of AI\\
}
