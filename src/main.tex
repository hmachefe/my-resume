...
\pointskillNinety{}{ffmpeg, mediainfo, fprobe}
...
\begin{cvtableNew}
  ...
  \cvitemRightNew
    ...
    {NDS Technologies} % Company
    {
      ...
      \vspace{4pt}
      \textbf{Responsibilities}: Built features with HTML5, CSS3D, WebGL, BackboneJS, ThreeJS (Collada), Tween.js. Optimized HW performance for QT5/WebKit, WebKitNix, Chromium. Cross-compiled web engines and gstreamers to target LG TVs, Raspberry Pi, Cotton Candy, MacOS rendering the same webapp.\par
      \vspace{4pt}
  ...
  \cvitemRightNew
    ...
    {Pay-TV System Integrator} % Job title
    {Canal+} % Company
    {
      \vspace{1pt}
      \fontsize{10.8pt}{12pt}\selectfont % Subtle font increase
    ...
    {DSP Engineer: AEC for Mobiles} % Job title
    {ALTEN} % Company
    {
      \vspace{1pt}
      \fontsize{10.8pt}{12pt}\selectfont % Subtle font increase
