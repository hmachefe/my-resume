...
\begin{cvtableNew}
  \cvitemRightNew
      ...
      {\vspace{0.4pt}
        ...
        \noindent\hspace*{1mm}*\textbf{difuzego.com:} Upgraded to Angular 14. Implemented MFA authentication. Helped to migrate data from ElasticSearch to Postgre (Knex-compliant model). Built a file upload module with AWS Step Functions for compressed proxies. Expanded workflow with on-prem Node.js workers (Express) and SQLite. Worked on MPEG/DASH encoding (AWS Mediaconvert, later Hybrik), HLS (AWS EC2 MacOS, later FFMPEG), and AES-128 encryption. Tools: Postgres, SQL Server, Bitmovin, Accurate.\vspace{5pt}

        \noindent\hspace*{1mm}*\textbf{difuzevox.com:} Integrated Azure Text-to-Speech, FFMPEG, MediaInfo, and Auphonic APIs. Used TTML for voice generation and Video.js for multimedia. Managed Terraform infrastructure. Led a team of 3 developers and 1 QA. Focused on media accessibility.\vspace{5pt}

        \noindent\hspace*{1mm}*\textbf{AI Detection Project:} Developed solutions for detecting mouth shapes ("pucker"), scene changes, and burnt-in text using 3rd-party AI tools. Managed multi-window/browser communication (postMessage).\vspace{5pt}

        \textbf{CI/CD:} Contributed to Kubernetes-based deployments.\vspace{5pt}
    ...
    {LVL Studio} % Company (without location here)
      {
        ...
        \textbf{Architecture}: Monolithic, no µservices. Shared data model UI \& API\vspace{5pt}
