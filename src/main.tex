...
% date of birth
\cvbirthday{\textbf{Date of Birth}: May. 5, 1974}
...
%   	\pointskill{\flag{FR.png}}{French}{3}
    ...
    \pointskillNinety{}{JavaScript (ECMA 6)}
    \pointskillNinety{}{TypeScript (3.2.4)}
    ...
    \pointskillFifty{}{C (cross-compilation)}
    \pointskillForty{}{C++ (cross-compilation)}
