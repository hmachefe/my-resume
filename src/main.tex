...
\simpleheader{headercolour}{Full Stack Developer | Tech Lead | Typescript, Angular, React, NodeJS | AWS}{white}
...
{\footnotesize
I'm a tech lead, full stack developer, and DevOps at Difuze, a media asset management company serving the entertainment industry. With 26 years of experience in web application development across, among others, digital TV, media platforms, laptops, mobiles, and more, I work with various technologies like AWS, Angular, Vue.js, React, PHP, Python, and HTML5.

In my role, I oversee the architecture, development, and deployment of two web projects, including one on Azure, while managing a team of 4 developers and 1 QA. I also contribute to improving our software stack through module creation, code reviews, and adherence to agile best practices. I'm passionate about web innovation, solving complex problems, and delivering scalable, user-friendly solutions.}
\bigskip

\bg{cvgreen}{white}{personal} \\[0.5em]
Swimming, reading, movies, international geopolitics, high tech
...
{\scriptsize
\hspace*{-3.4em} \infobubble{\faAt}{cvgreen}{white}{hugo.machefer@gmail.com} \\
\hspace*{-4.6em} \infobubble{\faLinkedin}{cvgreen}{white}{linkedin.com/in/hugomachefer} \\
\hspace*{-3.4em} \infobubble{\faGithub}{cvgreen}{white}{https://github.com/hmachefe}
}
