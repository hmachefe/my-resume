...
\vspace*{-9mm}  % Adjusts the vertical space, move content up by 10mm
  ...
  \profilesection{Teaching, Talks }
	...
	\aboutme{
    With more than 26 years of experience in web development for digital TV, media platforms, and mobile devices, I have spearheaded the architecture, development, and deployment of multiple projects. My leadership has focused on improving our software stack through module creation, code reviews, and the adoption of agile practices. I am dedicated to crafting user-friendly and scalable web solutions leveraging technologies such as AWS, Angular, Vue.js, React, PHP, Python, HTML5, and AI.}\\
}
%-------------------------------------------------------------------------------
